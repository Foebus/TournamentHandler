...
class TestGroup(TestCase):
    def test_give_point(self):
        ...
        g.give_point(m1, 203)
        self.assertEqual(m1.points, 203)
        self.assertEqual(m2.points, 0)
        self.assertEqual(m3.points, 0)
        self.assertEqual(m4.points, 0)
        g.give_point(m2, 22)
        g.give_point(m3, 13)
        g.give_point(m4, 17)
        g.give_point(m4, 2)
        self.assertEqual(m1.points, 203)
        self.assertEqual(m2.points, 22)
        self.assertEqual(m3.points, 13)
        self.assertEqual(m4.points, 19)
    ...
    def test_remove_challenger(self):
        ...
        g.sort_challengers_by_points()
        self.assertSequenceEqual(g.challengers, [m1, m2, m3])
        g.remove_challenger(m3)
        g.sort_challengers_by_points()
        self.assertSequenceEqual(g.challengers, [m1, m2])
    ...
    def test_add_subgroup(self):
        ...
        self.assertSetEqual(set(g1.subgroups), set([]))
        g1.add_subgroup(g2)
        self.assertSetEqual(set(g1.subgroups), {g2})
        g1.add_subgroup(g3)
        self.assertSetEqual(set(g1.subgroups), {g2, g3})
    ...
    def test_get_subgroups(self):
        ...
        self.assertSetEqual(set(g1.get_subgroups()), set([]))
        g1.add_subgroup(g2)
        self.assertSetEqual(set(g1.get_subgroups()), {g2})
        g1.add_subgroup(g3)
        self.assertSetEqual(set(g1.get_subgroups()), {g2, g3})
